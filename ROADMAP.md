...
- [ ] Add routing for overview, nodes, pipelines, backups, and automation
- [ ] Connect the fleet list to a real data source
- [ ] Add detail drawers or pages for individual server nodes
- [ ] Introduce persistent filters and saved views
- [ ] Add empty, loading, and error states

## Phase 3: Operations Features

- [ ] Deploy action flows with confirmation states
- [ ] Backup history and restore management
- [ ] Alerts center with severity filtering
- [ ] Environment switching and role-aware permissions
- [ ] Real charts for latency, CPU, memory, and network health
